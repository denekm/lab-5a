...
function multiplyArray(multArr) { //eslint-disable-line
  let multiplyOne = multiply(multArr[0], multArr[1]);
  let totalMultiply = multiply(multiplyOne[0],multArr[2]);
  let message = `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of ${totalMultiply[0]}.`;
  return[totalMultiply[0], message];

}

let multiplyArrayReturn = multiplyArray(testArray);
console.log(multiplyArrayReturn);
